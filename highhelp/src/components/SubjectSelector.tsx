...
export const SubjectSelector = (props: { baseUrl: string, type: 'standard' | 'essay' }) => {
    ...
    return (
        <div class="space-y-4">
            {/* Priority Subjects */}
            <div>
                <h3 class="text-xs font-bold text-gray-400 dark:text-neutral-500 tracking-widest mb-2">Popular Subjects</h3>
            ...
            {/* All Other Subjects */}
            <div>
                <h3 class="text-xs font-bold text-gray-400 dark:text-neutral-500 tracking-widest mb-2">All Subjects</h3>
                <div class="flex flex-wrap">
