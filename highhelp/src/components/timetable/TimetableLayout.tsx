...
export const TimetableLayout = ({ children }: { children: Child }) => (
    <div class="max-w-4xl mx-auto pt-0 pb-6 px-4" id="app-container">
        ...
        <div id="content" class="hidden">
            <div class="flex overflakruow-x-auto overflow-y-hidden border-b border-gray-200 dark:border-neutral-700 mb-3 scrollbar-hide">
                ...
                <button id="tab-calendar" class="flex items-center gap-1.5 px-3 sm:px-4 py-2 border-b-2 border-transparent text-gray-500 dark:text-neutral-400 hover:text-gray-700 dark:hover:text-neutral-200 font-medium text-xs sm:text-sm whitespace-nowrap focus:outline-none transition-colors flex-shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                    Exams
                </button>
                <button id="tab-highnotes" class="flex items-center gap-1.5 px-3 sm:px-4 py-2 border-b-2 border-transparent text-gray-500 dark:text-neutral-400 hover:text-gray-700 dark:hover:text-neutral-200 font-medium text-xs sm:text-sm whitespace-nowrap focus:outline-none transition-colors flex-shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    High Notes
                </button>
